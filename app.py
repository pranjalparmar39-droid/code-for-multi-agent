...
# ─────────────────────────────────────────────
# INITIALIZE AGENT (lazy, on first message)
# ─────────────────────────────────────────────
def get_agent():
...
if st.session_state.pending_query:
    ...
    user_input = st.chat_input("Ask me anything — I'll search the web, Wikipedia, calculate, or read your PDF...")
